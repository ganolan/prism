...
describe('PastCoursesPanel', () => {
  ...
  it('per-course Import calls importCourse and removes it from the not-imported list', async () => {
    getPastSections.mockResolvedValue(DISCOVERED);
    importCourse.mockResolvedValue({});
    renderPanel();
    expand();
    ...
    await waitFor(() => expect(screen.queryByText(/Import all/)).not.toBeInTheDocument());
  });
