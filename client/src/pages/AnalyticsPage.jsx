...
import {
  ...
  Tooltip, Legend, ReferenceLine, ErrorBar, BarChart, LineChart, Cell,
} from 'recharts';
import { getCourse, getCourseAnalytics, getCourseAssignments, updateAssignmentType, runAutoFlags } from '../services/api.js';
...
export default function AnalyticsPage() {
  ...
  function reload() {
    Promise.all([getCourse(id), getCourseAnalytics(id), getCourseAssignments(id)])
      .then(([c, a, asgn]) => { setCourse(c); setAnalytics(a); setAssignments(asgn); })
      .catch(console.error)
